Time: $O\!\(n \log\log n\)$,\quad Space: $O\!\(n\)$. \cite{sieve_eratosthenes}
...
\begin{algorithm}[ht]
    \inputminted[linenos, frame=lines]{python}{
        code/algorithms/math/sieve_eratosthenes.py}
    \caption{Sieve of Eratosthenes\label{alg:sieve_eratosthenes}}
\end{algorithm}