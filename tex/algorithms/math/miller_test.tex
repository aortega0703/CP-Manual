...
Table \ref{tab:miller} contains some of these with their respective bounds.
...
\begin{algorithm}[ht]
    \inputminted[linenos, frame=lines]{python}{
        code/algorithms/math/miller_test.py
    }
    \caption{Miller Primality Test\label{alg:miller}}
\end{algorithm}
